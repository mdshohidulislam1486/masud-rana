    ...
    >
     ...
     <Container  sx={{display:'flex', alignItems:'center',justifyContent:"space-between",flexDirection:{md:'row', xs:"column-reverse"},}}>
        <Box sx={{mx:2, my:5, zIndex:2, color:'#ffff'}}>
            ...
            <Box sx={{display:"flex", color:'#e94e00', my:3, cursor:'pointer'}}><Typography>Let's Connect </Typography> <ArrowCircleRightIcon/></Box>
        </Box>
        <Box sx={{mx:2, minWidth:'50%', display:"flex", justifyContent:{sm:"right"}}}>
            <img src={proPic} alt="myPropic"  style={{width:'80%', height:'80%', zIndex:2}}/>
        </Box>
    </Container>
